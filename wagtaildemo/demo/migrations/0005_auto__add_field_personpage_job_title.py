...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonPage.job_title'
        db.add_column(u'demo_personpage', 'job_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonPage.job_title'
        db.delete_column(u'demo_personpage', 'job_title')
