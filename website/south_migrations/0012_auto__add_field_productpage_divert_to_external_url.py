...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductPage.divert_to_external_url'
        db.add_column(u'website_productpage', 'divert_to_external_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductPage.divert_to_external_url'
        db.delete_column(u'website_productpage', 'divert_to_external_url')
    ...
    models = {
        ...
        u'website.productpage': {
            ...
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'divert_to_external_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'header_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            'intro': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
