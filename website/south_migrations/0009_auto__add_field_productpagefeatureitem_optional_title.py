...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductPageFeatureItem.optional_title'
        db.add_column(u'website_productpagefeatureitem', 'optional_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductPageFeatureItem.optional_title'
        db.delete_column(u'website_productpagefeatureitem', 'optional_title')
