...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ProductPageCarouselItem'
        db.delete_table(u'website_productpagecarouselitem')

        # Adding model 'ProductPageFeatureItem'
        db.create_table(u'website_productpagefeatureitem', (
            ...
            ('image_thumbnail', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image'])),
            ('embed_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('short_caption', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('long_caption', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='feature_items', to=orm['website.ProductPage'])),
        ))
        db.send_create_signal(u'website', ['ProductPageFeatureItem'])

        # Deleting field 'ProductIndexPage.body'
        db.delete_column(u'website_productindexpage', 'body')

        # Adding field 'ProductIndexPage.intro'
        db.add_column(u'website_productindexpage', 'intro',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'ProductPage.feed_image'
        db.delete_column(u'website_productpage', 'feed_image_id')

        # Deleting field 'ProductPage.logo'
        db.delete_column(u'website_productpage', 'logo_id')

        # Adding field 'ProductPage.body'
        db.add_column(u'website_productpage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.key_image'
        db.add_column(u'website_productpage', 'key_image',
        ...
        # Adding field 'ProductPage.header_image'
        db.add_column(u'website_productpage', 'header_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image']),
                      keep_default=False)


        # Changing field 'ProductPage.intro'
        db.alter_column(u'website_productpage', 'intro', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding model 'ProductPageCarouselItem'
        db.create_table(u'website_productpagecarouselitem', (
            ...
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='carousel_items', to=orm['website.ProductPage'])),
        ))
        db.send_create_signal(u'website', ['ProductPageCarouselItem'])

        # Deleting model 'ProductPageFeatureItem'
        db.delete_table(u'website_productpagefeatureitem')

        # Adding field 'ProductIndexPage.body'
        db.add_column(u'website_productindexpage', 'body',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'ProductIndexPage.intro'
        db.delete_column(u'website_productindexpage', 'intro')

        # Adding field 'ProductPage.feed_image'
        db.add_column(u'website_productpage', 'feed_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailimages.Image'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.logo'
        db.add_column(u'website_productpage', 'logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['wagtailimages.Image'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'ProductPage.body'
        db.delete_column(u'website_productpage', 'body')

        # Deleting field 'ProductPage.key_image'
        db.delete_column(u'website_productpage', 'key_image_id')

        # Deleting field 'ProductPage.header_image'
        db.delete_column(u'website_productpage', 'header_image_id')


        # Changing field 'ProductPage.intro'
        db.alter_column(u'website_productpage', 'intro', self.gf('wagtail.wagtailcore.fields.RichTextField')())
