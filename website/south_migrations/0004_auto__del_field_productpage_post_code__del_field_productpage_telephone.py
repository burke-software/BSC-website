...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductPage.post_code'
        db.delete_column(u'website_productpage', 'post_code')

        # Deleting field 'ProductPage.telephone'
        db.delete_column(u'website_productpage', 'telephone')

        # Deleting field 'ProductPage.city'
        db.delete_column(u'website_productpage', 'city')

        # Deleting field 'ProductPage.country'
        db.delete_column(u'website_productpage', 'country')

        # Deleting field 'ProductPage.address_1'
        db.delete_column(u'website_productpage', 'address_1')

        # Deleting field 'ProductPage.address_2'
        db.delete_column(u'website_productpage', 'address_2')

        # Deleting field 'ProductPage.email'
        db.delete_column(u'website_productpage', 'email')


    def backwards(self, orm):
        # Adding field 'ProductPage.post_code'
        db.add_column(u'website_productpage', 'post_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.telephone'
        db.add_column(u'website_productpage', 'telephone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.city'
        db.add_column(u'website_productpage', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.country'
        db.add_column(u'website_productpage', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.address_1'
        db.add_column(u'website_productpage', 'address_1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.address_2'
        db.add_column(u'website_productpage', 'address_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProductPage.email'
        db.add_column(u'website_productpage', 'email',
