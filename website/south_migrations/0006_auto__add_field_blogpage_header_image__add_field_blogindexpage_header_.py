...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPage.header_image'
        db.add_column(u'website_blogpage', 'header_image',
        ...
        # Adding field 'BlogIndexPage.header_image'
        db.add_column(u'website_blogindexpage', 'header_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPage.header_image'
        db.delete_column(u'website_blogpage', 'header_image_id')

        # Deleting field 'BlogIndexPage.header_image'
        db.delete_column(u'website_blogindexpage', 'header_image_id')
